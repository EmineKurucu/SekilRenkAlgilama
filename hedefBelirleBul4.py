...
while True:
    ...
    # "Hedef Belirleniyor..." mesajı ekrana yazdır
    if not target_found:
        cv2.putText(frame, "Hedef Belirleniyor...", (20, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
        ...
        for cnt in contours:
            ...
            if target_found:
                if color_name == target_color and shape == target_shape:
                    ...
                    cv2.putText(frame, "Hedef Bulundu!", (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.6, color, 2)
            else:
                cv2.rectangle(frame, (x, y), (x + w, y + h), color, 2)
                ...
                if target_color is None and target_shape is None:
                    ...
                    target_shape = shape
                    target_found = True
                    cv2.putText(frame, f"Hedef Belirlendi: {target_color} {target_shape}", (20, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
